...
* **Target File**: `hflung_trunc_2019-05-28-14-44-45-L5_6_3.wav`
* **True Target Concept**: `Stridor`
* **Base CNN Prediction**: `Stridor` (Confidence: **99.60%**)
...
* **Contrastive Prediction**: `Stridor` (Confidence: **99.85%**)
...
<table>
  ...
  <tr>
    <td align="center">
      <audio controls>
        <source src="audio/stridor_31850_target.wav" type="audio/wav">
    ...
    <td align="center">
      <audio controls>
        <source src="audio/stridor_31850_vs_class0_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-24.5979` | `-40.1919` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0018` | `0.0008` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `11.4595` | `16.1425` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `297.6368` | `531.8420` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/stridor_31850_vs_class1_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-24.5979` | `-54.0524` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0018` | `0.0006` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `11.4595` | `9.0868` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `297.6368` | `777.6409` | `Target is LOWER` | `Target is LOWER` | **AGREE** |
...
* **Contrastive Prediction**: `Stridor` (Confidence: **99.84%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/stridor_31850_vs_class2_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-24.5979` | `-20.6362` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0018` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `0.2000` | `0.2000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Pause Ratio** | `0.0000` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `11.4595` | `3.5890` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `297.6368` | `338.6614` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Stridor` (Confidence: **99.87%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/stridor_31850_vs_class3_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-24.5979` | `-21.6069` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0018` | `0.0053` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `11.4595` | `7.7658` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `297.6368` | `324.0090` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Stridor` (Confidence: **99.88%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/stridor_31850_vs_class5_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-24.5979` | `-4.8853` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0018` | `0.0037` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `0.2000` | `0.2000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Pause Ratio** | `0.0000` | `0.0064` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `11.4595` | `1.7128` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `297.6368` | `775.5483` | `Target is LOWER` | `Target is LOWER` | **AGREE** |
