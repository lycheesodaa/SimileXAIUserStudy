...
* **Target File**: `hflung_steth_20190516_14_50_36_5.wav`
* **True Target Concept**: `Stridor`
* **Base CNN Prediction**: `Rhonchi` (Confidence: **77.98%**)
...
* **Contrastive Prediction**: `Rhonchi` (Confidence: **78.34%**)
...
<table>
  ...
  <tr>
    <td align="center">
      <audio controls>
        <source src="audio/stridor_27508_target.wav" type="audio/wav">
    ...
    <td align="center">
      <audio controls>
        <source src="audio/stridor_27508_vs_class0_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-30.5737` | `-40.1919` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0532` | `0.0008` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `11.3757` | `16.1425` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `373.0143` | `531.8420` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Rhonchi` (Confidence: **74.50%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/stridor_27508_vs_class1_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-30.5737` | `-54.0524` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0532` | `0.0006` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `11.3757` | `9.0868` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `373.0143` | `777.6409` | `Target is LOWER` | `Target is LOWER` | **AGREE** |
...
* **Contrastive Prediction**: `Rhonchi` (Confidence: **78.83%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/stridor_27508_vs_class2_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-30.5737` | `-20.6362` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0532` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `0.2000` | `0.2000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Pause Ratio** | `0.0000` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `11.3757` | `3.5890` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `373.0143` | `338.6614` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Rhonchi` (Confidence: **75.46%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/stridor_27508_vs_class4_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-30.5737` | `-38.6100` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0532` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `11.3757` | `10.2898` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `373.0143` | `650.8252` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Rhonchi` (Confidence: **69.19%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/stridor_27508_vs_class5_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-30.5737` | `-4.8853` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0532` | `0.0037` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `0.2000` | `0.2000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Pause Ratio** | `0.0000` | `0.0064` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `11.3757` | `1.7128` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `373.0143` | `775.5483` | `Target is LOWER` | `Target is LOWER` | **AGREE** |
