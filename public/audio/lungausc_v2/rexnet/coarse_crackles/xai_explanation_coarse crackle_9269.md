...
* **Target File**: `sprsound_64913238_0.6_1_p3_3014_1.wav`
* **True Target Concept**: `Coarse Crackle`
* **Base CNN Prediction**: `Coarse Crackle` (Confidence: **100.00%**)
* **RexNet Contrastive Prediction (Consensus)**: `Coarse Crackle`
...
* **Contrastive Prediction**: `Coarse Crackle` (Confidence: **100.00%**)
...
<table>
  <tr>
    <th align="center">Target Sound Sample (Coarse Crackle)</th>
  ...
  <tr>
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_9269_target.wav" type="audio/wav">
    ...
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_9269_vs_class1_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-51.3444` | `-54.0524` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0024` | `0.0006` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `21.7853` | `9.0868` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `722.4443` | `777.6409` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_9269_vs_class2_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-51.3444` | `-20.6362` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0024` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `0.4000` | `0.2000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Pause Ratio** | `0.0064` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `21.7853` | `3.5890` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Spectral Width (Fineness)** | `722.4443` | `338.6614` | `Target is HIGHER` | `Target is SIMILAR` | **DISAGREE** |
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_9269_vs_class3_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-51.3444` | `-21.6069` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0024` | `0.0053` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `21.7853` | `7.7658` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `722.4443` | `324.0090` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_9269_vs_class4_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-51.3444` | `-38.6100` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0024` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `21.7853` | `10.2898` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `722.4443` | `650.8252` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_9269_vs_class5_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-51.3444` | `-4.8853` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0024` | `0.0037` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `0.4000` | `0.2000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Pause Ratio** | `0.0064` | `0.0064` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `21.7853` | `1.7128` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Spectral Width (Fineness)** | `722.4443` | `775.5483` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
