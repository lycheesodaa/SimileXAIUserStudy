...
* **Target File**: `sprsound_41090976_3.7_0_p4_6964_1.wav`
...
<table>
  ...
  <tr>
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_24076_target.wav" type="audio/wav">
    ...
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_24076_vs_class1_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-31.8405` | `-54.0524` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0000` | `0.0006` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `2.2000` | `0.2000` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Pause Ratio** | `0.3472` | `0.0000` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Crackle Spikiness** | `8.3165` | `9.0868` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `435.2522` | `777.6409` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_24076_vs_class2_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-31.8405` | `-20.6362` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0000` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `2.2000` | `0.2000` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Pause Ratio** | `0.3472` | `0.0000` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Crackle Spikiness** | `8.3165` | `3.5890` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `435.2522` | `338.6614` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_24076_vs_class3_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-31.8405` | `-21.6069` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0000` | `0.0053` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `2.2000` | `0.6000` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Pause Ratio** | `0.3472` | `0.4288` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `8.3165` | `7.7658` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `435.2522` | `324.0090` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_24076_vs_class4_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-31.8405` | `-38.6100` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0000` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `2.2000` | `2.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Pause Ratio** | `0.3472` | `0.4432` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `8.3165` | `10.2898` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `435.2522` | `650.8252` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/coarse crackle_24076_vs_class5_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-31.8405` | `-4.8853` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0000` | `0.0037` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `2.2000` | `0.2000` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Pause Ratio** | `0.3472` | `0.0064` | `Target is SIMILAR` | `Target is HIGHER` | **DISAGREE** |
| **Crackle Spikiness** | `8.3165` | `1.7128` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `435.2522` | `775.5483` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
