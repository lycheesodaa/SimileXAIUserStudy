...
* **Target File**: `icbhi_195_1b1_Pl_sc_Litt3200_4.wav`
* **True Target Concept**: `Wheeze`
* **Base CNN Prediction**: `Wheeze` (Confidence: **71.72%**)
...
* **Contrastive Prediction**: `Wheeze` (Confidence: **61.55%**)
...
<table>
  ...
  <tr>
    <td align="center">
      <audio controls>
        <source src="audio/wheeze_147_target.wav" type="audio/wav">
    ...
    <td align="center">
      <audio controls>
        <source src="audio/wheeze_147_vs_class0_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-25.3777` | `-40.1919` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0046` | `0.0008` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `9.8098` | `16.1425` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `272.0478` | `531.8420` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Wheeze` (Confidence: **65.32%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/wheeze_147_vs_class1_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-25.3777` | `-54.0524` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0046` | `0.0006` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `9.8098` | `9.0868` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `272.0478` | `777.6409` | `Target is LOWER` | `Target is LOWER` | **AGREE** |
...
* **Contrastive Prediction**: `Wheeze` (Confidence: **51.77%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/wheeze_147_vs_class2_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-25.3777` | `-20.6362` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0046` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `0.2000` | `0.2000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Pause Ratio** | `0.0000` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `9.8098` | `3.5890` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `272.0478` | `338.6614` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Wheeze` (Confidence: **53.98%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/wheeze_147_vs_class3_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-25.3777` | `-21.6069` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0046` | `0.0053` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `9.8098` | `7.7658` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `272.0478` | `324.0090` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Wheeze` (Confidence: **62.83%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/wheeze_147_vs_class4_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-25.3777` | `-38.6100` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0046` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `9.8098` | `10.2898` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `272.0478` | `650.8252` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
