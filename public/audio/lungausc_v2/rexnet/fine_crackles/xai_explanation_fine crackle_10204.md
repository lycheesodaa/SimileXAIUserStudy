...
* **Target File**: `sprsound_65080696_11.1_1_p4_1831_0.wav`
* **True Target Concept**: `Fine Crackle`
* **Base CNN Prediction**: `Fine Crackle` (Confidence: **99.73%**)
...
<table>
  ...
  <tr>
    <td align="center">
      <audio controls>
        <source src="audio/fine crackle_10204_target.wav" type="audio/wav">
    ...
    <td align="center">
      <audio controls>
        <source src="audio/fine crackle_10204_vs_class0_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-56.3326` | `-40.1919` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0017` | `0.0008` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `19.2793` | `16.1425` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `934.0821` | `531.8420` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/fine crackle_10204_vs_class2_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-56.3326` | `-20.6362` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0017` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `19.2793` | `3.5890` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Spectral Width (Fineness)** | `934.0821` | `338.6614` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
...
* **Contrastive Prediction**: `Fine Crackle` (Confidence: **99.64%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/fine crackle_10204_vs_class3_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-56.3326` | `-21.6069` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0017` | `0.0053` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `19.2793` | `7.7658` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `934.0821` | `324.0090` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
...
* **Contrastive Prediction**: `Fine Crackle` (Confidence: **99.65%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/fine crackle_10204_vs_class4_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-56.3326` | `-38.6100` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.0017` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
| **Crackle Spikiness** | `19.2793` | `10.2898` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `934.0821` | `650.8252` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Fine Crackle` (Confidence: **99.82%**)
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/fine crackle_10204_vs_class5_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-56.3326` | `-4.8853` | `Target is LOWER` | `Target is SIMILAR` | **DISAGREE** |
| **High-Frequency Sharpness** | `0.0017` | `0.0037` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Breath / Crackle Frequency** | `0.2000` | `0.2000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Pause Ratio** | `0.0000` | `0.0064` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `19.2793` | `1.7128` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Spectral Width (Fineness)** | `934.0821` | `775.5483` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
