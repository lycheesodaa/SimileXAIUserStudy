...
* **Target File**: `hflung_trunc_2019-07-16-11-11-47-L2_12_10.wav`
* **True Target Concept**: `Rhonchi`
* **Base CNN Prediction**: `Rhonchi` (Confidence: **49.22%**)
...
* **Contrastive Prediction**: `Rhonchi` (Confidence: **50.19%**)
...
<table>
  ...
  <tr>
    <td align="center">
      <audio controls>
        <source src="audio/rhonchi_28542_target.wav" type="audio/wav">
    ...
    <td align="center">
      <audio controls>
        <source src="audio/rhonchi_28542_vs_class0_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-27.3009` | `-40.1919` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.1775` | `0.0008` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
...
| **Crackle Spikiness** | `7.7900` | `16.1425` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `442.4854` | `531.8420` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Rhonchi` (Confidence: **48.99%**)
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/rhonchi_28542_vs_class1_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-27.3009` | `-54.0524` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.1775` | `0.0006` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
...
| **Crackle Spikiness** | `7.7900` | `9.0868` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `442.4854` | `777.6409` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Stridor` (Confidence: **44.14%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/rhonchi_28542_vs_class2_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-27.3009` | `-20.6362` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.1775` | `0.0000` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Breath / Crackle Frequency** | `0.2000` | `0.2000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Pause Ratio** | `0.0000` | `0.0000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `7.7900` | `3.5890` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `442.4854` | `338.6614` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Rhonchi` (Confidence: **45.09%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/rhonchi_28542_vs_class4_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-27.3009` | `-38.6100` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.1775` | `0.0000` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
...
| **Crackle Spikiness** | `7.7900` | `10.2898` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `442.4854` | `650.8252` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
...
* **Contrastive Prediction**: `Stridor` (Confidence: **52.27%**)
* **NNRank Relation Predictor Accuracy**: **6/6 Cues Correct**
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <audio controls>
        <source src="audio/rhonchi_28542_vs_class5_contrast.wav" type="audio/wav">
        Your browser does not support the audio element.
      </audio>
    </td>
  </tr>
...
| Concept Cue | Target Value | Foil Value | Heuristic Relation | Model predicted relation | Match |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Loudness / Intensity** | `-27.3009` | `-4.8853` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **High-Frequency Sharpness** | `0.1775` | `0.0037` | `Target is HIGHER` | `Target is HIGHER` | **AGREE** |
| **Breath / Crackle Frequency** | `0.2000` | `0.2000` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Pause Ratio** | `0.0000` | `0.0064` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Crackle Spikiness** | `7.7900` | `1.7128` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
| **Spectral Width (Fineness)** | `442.4854` | `775.5483` | `Target is SIMILAR` | `Target is SIMILAR` | **AGREE** |
